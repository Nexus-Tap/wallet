  ...
  return (
    <>
      <div className="w-full mt-[150px] flex justify-center items-center">
        <p className="text-4xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-purple-400">
          Coin Yoink
        </p>
      </div>
      ...
      <div className="p-10 flex-1 flex flex-col justify-end">
        <button
          onClick={() => navigate("/auth/get-wallet-seed")}
          className="w-full flex justify-center items-center bg-gray-900 shadow-md py-2 px-4 mb-7 rounded-md"
        >
        ...
        <button
          onClick={() => navigate("/auth/create-wallet")}
